...
public class CecupTestContainer extends TestContainer {

    public CecupTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/rtcab/cecup/app.properties",
    ...
    public static class Common extends CecupTestContainer {

        public static final CecupTestContainer.Common INSTANCE = new CecupTestContainer.Common();
