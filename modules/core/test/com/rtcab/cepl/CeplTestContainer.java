...
public class CeplTestContainer extends TestContainer {

    public CeplTestContainer() {
        super();
    ...
    public static class Common extends CeplTestContainer {

        public static final CeplTestContainer.Common INSTANCE = new CeplTestContainer.Common();
